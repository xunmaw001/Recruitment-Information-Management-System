...
export default {
  ...
  methods: {
	...
	this.ruleForm.gongzuojingyan = this.ruleForm.gongzuojingyan.replace(reg,'../../../springbootlny2s/upload');
	this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../springbootlny2s/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
