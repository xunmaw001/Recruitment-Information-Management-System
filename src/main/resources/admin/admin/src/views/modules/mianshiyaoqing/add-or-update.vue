<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邀请标题" prop="yaoqingbiaoti">
          <el-input v-model="ruleForm.yaoqingbiaoti" 
              placeholder="邀请标题" clearable  :readonly="ro.yaoqingbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邀请标题" prop="yaoqingbiaoti">
              <el-input v-model="ruleForm.yaoqingbiaoti" 
                placeholder="邀请标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="邀请详情" prop="yaoqingxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yaoqingxiangqing" label="邀请详情" prop="yaoqingxiangqing">
                    <span v-html="ruleForm.yaoqingxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yaoqingxiangqing = this.ruleForm.yaoqingxiangqing.replace(reg,'../../../springbootlny2s/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
